            ...
            <a href="#"
               class="group flex flex-row items-center px-4 hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 24 24"
                     fill="currentColor"
                     class="m-1.5 h-8 w-8 fill-none stroke-green-600 group-hover:fill-green-600 group-hover:stroke-green-600">
            ...
            <a href="#"
               class="group flex flex-row items-center px-4 hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 24 24"
                     fill="currentColor"
                     class="m-1.5 h-8 w-8 fill-none stroke-red-600 group-hover:fill-red-600 group-hover:stroke-red-600">
